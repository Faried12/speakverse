    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-slate-500 dark:text-slate-400">
                    Manage reading materials for this lesson
                </p>
            </div>

            <a href="{{ route('admin.reading-materials.create', $lesson->id) }}"
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div
                    class="px-4 py-2 rounded-xl bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-sm font-semibold">
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-5">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ route('admin.reading-materials.edit', $material->id) }}"
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="mt-2 text-slate-500 dark:text-slate-400">
                        ...
                        Start by creating your first reading material.
