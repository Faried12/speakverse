...
@section('content')
    @php
        ...
        $formAction = $isLessonMode
            ? route('admin.writing-lesson-questions.store', $lesson->id)
            : route('admin.writing-questions.store', $material->id);
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-slate-500 dark:text-slate-400">
                {{ $isLessonMode ? 'Create a new writing question for pre-test/post-test' : 'Create a new question for this writing material' }}
            </p>
        </div>
