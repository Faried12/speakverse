...
@section('content')
    @php
        ...
        $createRoute = $isLessonMode
            ? route('admin.writing-lesson-questions.create', $lesson->id)
            : route('admin.writing-questions.create', $material->id);
    @endphp
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-slate-500 dark:text-slate-400">
                    {{ $isLessonMode ? 'Manage writing questions for pre-test/post-test' : 'Manage questions for this writing material' }}
                </p>
            </div>
        ...
        <div
                            ...
                            <tr class="border-t border-slate-200 dark:border-slate-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        <a href="{{ route('admin.writing-questions.edit', $question->id) }}"
                                            class="px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white">
                                            Edit
                                        </a>

                                        <button type="button"
                                            data-url="{{ route('admin.writing-questions.destroy', $question->id) }}"
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="mt-2 text-slate-500 dark:text-slate-400">
                        Create your first writing question.
                    </p>
