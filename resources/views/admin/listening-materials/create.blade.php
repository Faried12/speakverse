...
@section('content') <div class="max-w-5xl mx-auto space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-500 dark:text-slate-400 mt-1">
            Create a new listening material for this lesson.
        </p>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow p-6">
        ...
        <form
            action="{{ route('admin.listening-materials.store', $lesson->id) }}"
            method="POST"
            ...
            <div class="flex gap-3">
                ...
                <a
                    href="{{ route('admin.listening-materials.index', $lesson->id) }}"
