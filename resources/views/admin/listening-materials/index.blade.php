    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-slate-500 dark:text-slate-400">
                Manage listening materials for this lesson
            </p>
        </div>

        <a href="{{ route('admin.listening-materials.create', $lesson->id) }}"
                        ...
                        @foreach ($materials as $material)
                            ...
                            <tr
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 text-sm font-medium">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    @if($material->audio_file)
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-sm font-medium">
                                    ...
                                    @else
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 text-sm font-medium">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <a href="{{ route('admin.listening-questions.index', $material->id) }}"
                                        ...
                                        <a href="{{ route('admin.listening-materials.edit', $material->id) }}"
        ...
        @else
            ...
            <div class="p-12 text-center">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white">
                    ...
                    No Listening Materials Yet

                </h3>

                <p class="mt-2 text-slate-500 dark:text-slate-400">

                    Start by creating your first listening material.
...
<div id="deleteModal"
    ...
    <div
        class="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
