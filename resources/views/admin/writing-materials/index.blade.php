...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div>
        ...
        <p class="mt-1 text-slate-500 dark:text-slate-400">
            Manage writing materials for this lesson
        </p>
    </div>

    <a href="{{ route('admin.writing-materials.create', $lesson->id) }}"
                    ...
                    <tr
                        ...
                        <td class="px-6 py-5">
                            ...
                            <div
                                ...
                                {{ Str::limit($material->passage, 120) }}
                        ...
                        <td class="px-6 py-5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a
                                    href="{{ route('admin.writing-materials.edit', $material->id) }}"
    ...
    @else
        ...
        <div class="p-12 text-center">
            ...
            <p class="mt-2 text-slate-500 dark:text-slate-400">
                Start by creating your first writing material.
            </p>
...
function openDeleteModal(id)
{
    ...
    form.action = `/admin/writing-materials/${id}`;
